package com.securenotes.security.jwt;
...
import org.springframework.stereotype.Component; import java.util.Date; import javax.crypto.SecretKey;
@Component
public class JwtUtils {
    private static final Logger logger = LoggerFactory.getLogger(JwtUtils.class);
    @Value("${securenotes.app.jwtSecret}") private String jwtSecret;
    @Value("${securenotes.app.jwtExpirationMs}") private int jwtExpirationMs;
    ...
    public boolean validateJwtToken(String authToken) {
        try { Jwts.parser().verifyWith(key()).build().parse(authToken); return true; }
